...
setfacl -R -m d:u:ximiDEV:rwx /data/corefile
setfacl -R -m u:ximiDEV:rwx /data/corefile
...
wget -q http://10.140.34.28/xyj/Initialize/sysctl.conf -O /etc/sysctl.conf
/sbin/sysctl -p
